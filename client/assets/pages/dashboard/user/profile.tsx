...
class DashboardUserCreatePage extends React.Component<IUserProfileProps & RouteComponentProps<IDetailPageRouteMatchProps>> {
    ...
    public render() {
        ...
        return (
            <div className="app-dashboard-user-create">
                ...
                <ModifyProfileForm defaultValue={user.detail} onSubmit={this.handleSubmit} loading={modal.loadingForm} permission={true} isCreate={match.params.id === 'create'} />
            </div>
        );
    }
    private handleSubmit = (data) => {
        ...
        const sendData = isCreate ? data : Object.assign({
